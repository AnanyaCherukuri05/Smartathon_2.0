    ...
    return (
        <div className="flex items-center justify-between p-4 bg-white shadow-sm z-10 sticky top-0">
            <div className="flex items-center gap-2">
                ...
                <h1 className="font-bold text-xl text-slate-800 tracking-tight">KisanSetu</h1>
            </div>

            <div className="flex items-center gap-3">
                {user && <span className="text-sm font-medium text-slate-500 hidden sm:block">Hi, {user.name}</span>}
